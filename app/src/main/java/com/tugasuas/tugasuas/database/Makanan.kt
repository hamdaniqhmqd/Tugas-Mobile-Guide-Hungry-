...
fun DataMakanan(): MutableList<Makanan> {
    ...
    data.add(
        Makanan(
            ...
            listOf(
                " Untuk membuat papeda: siapkan wadah dan tambahkan tepung sagu.",
                "Rebus air hingga mendidih dan tuang ke dalam wadah berisi tepung. Aduk hingga adonan lengket seperti lem.",
                "Untuk membuat kuah kuning: haluskan bawang merah, bawang putih, cabai rawit, kunyit, jahe, dan lengkuas.",
                "Geprek dan memarkan daun serai. ",
                "Iris halus daun bawang, daun jeruk, tomat, cabai merah, dan hijau. Sisihkan.",
                "Siapkan wajan, tumis bumbu halus dan daun serai hingga wangi. Tambahkan air dan masukkan ikan. ",
                "Beri garam dan perasan jeruk nipis. Masak hingga ikan matang.",
                "Koreksi rasa dan tambahkan bumbu jika kurang pas.",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                ...
                "5 buah cabai rawit",
                "Garam, gula, kaldu ayam bubuk dan gula secukupnya"
            ), // bahan
            listOf(
                "Iris sebuah bumbu yang telah disediakan, lalu tumis bawang putih dan bawang merah.",
                "Setelah mengeluarkan aroma wangi, masukkan cabai rawit dan tumis hingga matang.",
                "Selanjutnya adalah memasukkan sayur kangkung dan aduk hingga rata.",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                ...
                "Giling atau tumbuk semau bahan bumbu hingga halus.",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                "Cuci ayam dan kerat-kerat,haluskan bumbu lalu tumis beserta bumbu aromatik hingga harum.",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                "Cuci bersih cumi lalu potong-potong membulat setelah itu pakai perasan jeruk nipis diamkan selama 10 atau 15 menit.",
                "Setelah 10 atau 15 menit cuci kembali cumi lalu masukkan penyedap rasa, ladaku, ketumbar bubuk, bawang putih bubuk, dan garam, lalu diamkan 15 menit dan masukkan dalam kulkas.",
                "Siapkan dahulu tepung terigu yang dicampurkan tepung maizena, lalu masukkan soda kue, lalu aduk sampai rata,ini untuk tepung kering ya.",
                "Setelah 15 menit, ambil cumi yang tadi di kulkas lalu masukkan telur dan tepung (tepungnya ambil 3 sendok saja ditepung kering tadi). Setelah itu aduk sampai rata.",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                "Cuci bersih daging bebek, tiriskan.",
                "Taruh bebek kedlm panci, masukkan semua bumbu (bumbu halus dan bumbu aromatik)",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                ...
                "525 Gram tepung terigu pro rendah",
                "40 Gram susu full cream",
                "20 Gram tepung maizena",
                "2 sendok makan gula halus",
                "secukupnya Selai nanas",
                "2 kuning telur + 1sdm minyak untuk olesan nastar"
            ), // bahan
            listOf(
                "Campur mentega room butter dan gula halus sampai rata",
                "Kalo sudah merata masukan kuning telur,aduk sampai tercampur",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                ...
                "1 saset susu bubuk putih(3 sdm)",
                "2-3 butir kuning telur",
                "100-150 gram gula pasir",
                "150-200 gram mentega",
                "1/4 sdt garam (untuk mengunci kelembutan)",
                "3 sdt fermipan / ragi instan",
                "150 ml air hangat + 1sdt gula",
                "Gula "
            ), // bahan
            listOf(
                "Kukus kentang sampai matang, kemudian haluskan, sisihkan",
                "Campurkan gula dengan kuning telur, kocok hingga gula larut. Kemudian campurkan dengan kentang halus",
                "Siapkan air hangat, jangan terlalu panas ya untuk membuat biang, Air hangat di campur dengan sedikit gula (saya 1 sdt) dan di beri fermipan, aduk sebentar kemudian ditutup dan diamkan sampai berbuih",
                "Campurkan tepung kedalam adonan kentang tadi, step by step. Masukkin juga susu dan raginya, aduk hingga tercampur rata dan kalis",
                "Setelah adonan kalis, beri garam dan juga mentega, kemudian tutup dan diamkan sekitar 30 menit sampai mengembang",
                "Setelah adonan mengembang, kempes kan adonan agar udara keluar, dan bulat bulatkan adonan. ",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                ...
                "185 gr margarin/mentega",
                "50 gr gula galus",
                "1 butir kuning telur",
                "1/4 sdt garam",
                "Secukupnya gula salju/gula halus untuk topping"
            ), // bahan
            listOf(
                "Siapkan wadah lalu masukkan mentega, gula halus dan kuning telur lalu mixer hingga rata kurleb 60 detik, setelah tercampur rata lalu masukkan tepung terigu, maizena, susu bubuk dan garam lalu aduk hingga adonan kalis",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                "Rebus sagu mutiara sampai mndidih kurleb 15 menit. lalu matikan api kompor. tutup dg tutup panci, biarkan selama 30 menit",
                "Rebus 6 SDM gula dg 400ml air..atau tergantung selera",
                "Belah dan sisir kelapa",
                "memanjang",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                ...
                "75 gr Tepung terigu (penggunaan tapioka dan terigu 2:1, banyak tapioka)",
                "6 siung bawang putih",
                "1 sdt Garam",
                "1 sdm Royco (boleh kurang atau lebih)",
                "1/2 sdm Ladaku merica bubuk",
                "2 batang Daun bawang (opsional) secukupnya Air"
            ), // bahan
            listOf(
                "Potong tahu pong menjadi 2 bagian, menjadi bentuk segitiga",
                "Balik tahu pong, yang di dalam menjadi di luar. Keluarkan isi tahu pong kemudian sisihkan",
                "Uleg bawang putih hingga halus",
                "Masukkan bahan kering (tepung tapioka dan terigu) ke dalam wadah lalu campur",
                "Setelah itu masukkan ulegan bawang putih, garam, lada, royco, isian tahu dan daun bawang ke dalam wadah tepung tadi",
                "Campur semua bahan sebelum dimasukkan air",
                "Setelah itu masukkan air secara perlahan sedikit demi sedikit agar tidak terlalu encer",
                "Pastikan tekstur adonan tidak terlalu encer agar bisa dimasukkan ke dalam tahu (saran: tekstur adonan seperti adonan cilok)",
                "Pastikan rasa adonan sudah pas tidak terlalu asin",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                ...
                "Kerat bagian tengah tempe agar bumbu meresap",
                "Masukkan garam, merica, ketumbar, dan kaldu bubuk ke dalam tempe lalu aduk merata",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                "Kupas bawang merah, cuci bersih, rajang, cuci bersih cabe merah, potong serong",
                "Dadar telur dalam wadah, tambahkan bawang merah, lada bubuk, garam dan kaldu bubuk aduk hingga tercampur rata",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                ...
                "sejumput garam atau kaldu bubuk",
                "5 sdm minyak goreng"
            ), // bahan
            listOf(
    ...
    data.add(
        Makanan(
            ...
            listOf(
                ...
                "1 ruas kunyit",
                "50-100 ml minyak sayur",
                "kulit dan lemak ayam",
                "3 siung bawang putih (cincang)",
                "Tulang-tulang ayam (sy pakai tulang paha)",
                "500-1000 ltr air",
                "Secukupnya garam dan lada bubuk"
            ), // bahan
            listOf(
                "topping ayam : Pisahkan ayam dengan tulang dan kulit, ambil dagingnya saja, kemudian potong dadu (tulang untuk kaldu, kulit untuk minyak ayam)",
                "Tumis bumbu halus dg sereh, daun salam dan daun jeruk hingga matang dan harum",
                " Masukkan daging ayam, masak sampai berubah warna, kemudian tambahkan kecap, lada bubuk, garam, gula dan air kaldu secukupnya",
                " Masak sampai kuah menyusut (jika suka manis bisa tambahkan kecap)",
                "Ayam siap digunakan",
                "Kuah Kaldu :  Rebus tulang dg air, tambahkan garam, lada bubuk dan daun jeruk (opsional), masak dengan api kecil sampai sari-sarinya keluar",
                "Saring kuahnya",
                "Kuah kaldu siap digunakan",
                "Minyak Ayam : Pada wajan, tuang minyak sayur. Masukkan kulit dan lemak ayam",
                "Masak dengan api kecil hingga kulit ayam kering, angkat kulit dan masukkan bawang putih cincang",
                " Masak sampai bawang putih kering",
                "Minyak ayam siap digunakan",
                "1 mangkuk mie ayam: Pada mangkuk : masukkan 1 Sdm minyak ayam, 1 Sdt kecap ikan dan 1/2 Sdt lada bubuk",
                " Rebus mie, tuang ke mangkuk, aduk rata mie dengan bumbu",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                ...
                "1 sdt merica",
                "2 sdt garam",
                "100 gram tulang sumsum/ tulang iga",
                "100 gram es",
                "2 butir telur, ambil putihnya saja",
                "200 gram es untuk rendam rebusan bakso",
                "Bumbu Kuah:3 siung bawang putih",
                "4 butir kemiri",
                "5 cm daun bawang",
                "Pelengkap:Soun, seledri, bawang merah goreng, cabai rawit, mie kuning"
            ), // bahan
            listOf(
                "Rebus tulang dan 1,5 liter air selama 1 jam, matikan api.",
                " Blender daging hingga halus, lalu masukkan bawang merah putih goreng, garam, baking powder, merica, dan putih telur.",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                ...
                "1/4 cabe giling",
                "1 Santan kental dari 8 butir kelapa",
                "1 ons masing2 Bumbu halus",
                "(bawang merah, bawang putih, jahe, lengkuas)",
                "5 lembar daun salam",
                "2 batang sereh geprek",
                "Segenggam cabe rawit atau cabe setan untuk penambah rasa"
            ), // bahan
            listOf(
                "Perasan santan kental masukan kewajan bersama cabe dan bumbu halus beserta dedaunan",
                " Aduk sampai santan nya mendidih",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                ...
                "Bahan isian : Choco crunch",
                "Bahan pelapis :Tepung maizena sangrai secukupnya"
            ), // bahan
            listOf(
                "Campur dan aduk hingga rata tepung ketan, air, garam, dan gula, lalu saring.",
                "Kukus dalam wadah antilengket selama 25-30 menit atau sampai adonan transparan. Lalu angkat dan biarkan hangat.",
                "Tambahkan mentega putih lalu uleni hingga kalis 5-10 menit. Beri beberapa tetes pewarna makanan sesuai selera.",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                ...
                "75 gr gula pasir",
                "30 gr kental manis",
                "250 ml air bersih. Atau 200 ml air + 1 butir telur",
                "Bahan Isi :Coklat ceres",
                "Keju parut sesuai selera Atau lainnya"
            ), // bahan
            listOf(
                "Campurkan semua bahan crepes dan aduk rata.",
                "Tuangkan ke wadah plastik bawaan dr wajan walik",
                "Panaskan wajan walik dg api kecil hingga panas merata.",
                "Celup bagian atas wajan ke dalam adonan lalu balikkan",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                "Campur terigu,susu bubuk dan gula halus trus di ayak...lalu masukan margarin yang di bekukan terlebih dahulu di kulkas lalu diaduk2 sampe rata",
                "Setelah itu masukan telur aduk sampe menjadi adonan kulit pie",
                "Lanjut cetak kedalam cetakan pie.",
                "Selanjutnya membuat isian pie susu",
                "Campur air dan susu aduk sampe bercampur rata..lalu masukan vanili dan dan kuning telur aduk rata lagi",
                "Terakhir masukan tepung meizena",
                "Aduk lagi..lalu saring",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                "Masukkan 2 telur, gula dan mentega dalam 1 wadah.",
                "Mixer bahan tersebut sampai tercampur rata.",
                "Masukkan 500 ml air, lalu mixer kembali.",
                "Tambahkan 500 gr tepung, baking soda & vanili lalu mixer kembali hingga bahan tercampur rata.",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                ...
                "1/2 sdt garam",
                "60-80 ml air hangat",
                "Isian :6 buah slice burger beef",
                "6 lembar daun selada",
                "6 buah sosis",
                "2 buah tomat",
                "Secukupnya mayonais",
                "Secukupnya saos tomat",
                "Secukupnya saos keju"
            ), // bahan
            listOf(
                "Campurkan semua bahan kulit, uleni sampai kalis, diamkan 45 menit.",
                "Bagi menjadi 6 bagian, gilas tipis adonan lalu panggang di teflon sampai berubah warna.",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                ...
                "Bahan Sirup:250 gram kental manis",
                "500 gram gula pasir",
    ...
    data.add(
        Makanan(
            ...
            listOf(
                ...
                "500 ml air",
                "2 lembar daun pandan",
                "Bahan juruh/gula cair:200 gram gula merah",
                "500 ml air",
                "Santan:300 ml air",
                "65 ml santan instan"
            ), // bahan
            listOf(
                ...
                "Cetak dawet dengan saringan dan siapkan air es di bawahnya.",
